...
# subjects = ["", "Manaka Rar", "Minami Mirei", "Hojo Sofi",
#             "Todo Shion", "Dorosy West", "Dorosy Reona"]


subjects = ["", "Manaka Rar", "Minami Mirei"]
    ...
    for dir_name in dirs:
        ...
        for image_name in subject_images_names:
            ...
            if face is not None:
                ...
                labels.append(label)
                # cv2.imshow("fuck", draw_rectangle(image, rect))
